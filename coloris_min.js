...
!(function (u, p, s, c) {
  ...
  function W(e) {
    ...
    l.classList.contains("clr-field") ||
      ...
      (a = "clr-field"),
      (C.rtl || e.classList.contains("clr-rtl")) &&
        (a += " clr-rtl"),
      (t.innerHTML =
  ...
  function K(e) {
    var t = {
        pageX: ((a = e).changedTouches
          ? a.changedTouches[0]
          : a
        ).pageX,
        pageY: (a.changedTouches ? a.changedTouches[0] : a)
          .pageY,
      },
      a = t.pageX - A.x,
      t = t.pageY - A.y;
  ...
  function Q() {
    return Array.from(
      f.querySelectorAll("input, button"),
    ).filter(function (e) {
          ...
          "Escape" !== a
            ? "Enter" !== a || "BUTTON" === l.tagName
              ? ([
                  ...
                  ((n = !0),
                  f.classList.add("clr-keyboard-nav")),
                "Tab" === a &&
